function Footer() {
	return (
		<footer className="border-t border-white/5 bg-[#0b0605] py-16">
			<div className="mx-auto grid max-w-6xl gap-10 px-7 sm:grid-cols-2 lg:grid-cols-3">
				...
				<div>
					...
					<ul className="mt-4 space-y-3 text-sm text-muted">
						<li className="transition hover:text-text">IT scalability</li>
						<li className="transition hover:text-text">Software engineering</li>
						<li className="transition hover:text-text">AI systems</li>
						<li className="transition hover:text-text">Consulting</li>
					</ul>
				</div>
				<div>
					...
					<ul className="mt-4 space-y-3 text-sm text-muted">
						...
						<li>
							<a href="tel:+94769726890" className="transition hover:text-text">
								+94 76 972 6890
							</a>
						</li>
						<li>
							<a href="tel:+94760950718" className="transition hover:text-text">
								+94 76 095 0718
							</a>
						</li>
						<li className="text-muted">Colombo, Sri Lanka</li>
						<li className="text-muted">London, UK</li>
					</ul>
				</div>
			</div>
			<div className="mx-auto mt-12 flex max-w-6xl flex-col items-start justify-between gap-3 border-t border-white/5 px-7 pt-6 text-xs text-muted sm:flex-row sm:items-center">
